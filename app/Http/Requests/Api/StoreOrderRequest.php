...
class StoreOrderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.variant_id.required' => 'Setiap item pesanan harus memiliki produk yang dipilih.',
            'items.*.variant_id.exists'   => 'Salah satu produk dalam pesanan tidak ditemukan. Silakan periksa kembali.',
