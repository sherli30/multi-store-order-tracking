...
class StoreOrderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.product_id.required_without' => 'Setiap item pesanan harus memiliki produk yang dipilih.',
            'items.*.product_id.exists'   => 'Salah satu produk dalam pesanan tidak ditemukan.',
            'items.*.variant_id.required_without' => 'Setiap item pesanan harus memiliki produk yang dipilih.',
            'items.*.variant_id.exists'   => 'Salah satu varian produk dalam pesanan tidak ditemukan.',
