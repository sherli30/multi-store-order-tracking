...
@section('content')
    ...
    <div class="page-header" style="display: flex; align-items: flex-start; justify-content: space-between;">
        <div class="page-header-left">
            ...
            <p>Kelola daftar toko dan cabang penjualan Anda.</p>
        </div>
        ...
        <form action="{{ route('stores.index') }}" method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="products" class="form-input">
                        <option value="">Semua Jumlah</option>
                        {{-- Revisi: Menggunakan kategori yang lebih fungsional untuk 3 toko --}}
                        ...
                        <option value="many" {{ request('products') == 'many' ? 'selected' : '' }}>Banyak (> 5)
                        </option>
                    </select>
                </div>
            </div>
