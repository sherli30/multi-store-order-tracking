...
<head>
    ...
    <style>
        ...
        .report-title { font-size: 18px; font-weight: 700; color: #4b5563; }

        .period-info { font-size: 14px; font-weight: 600; color: #64748b; margin-top: 10px; }
        ...
        .stat-box { border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px; }
        .stat-label { font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; margin-bottom: 6px; }
        .stat-value { font-size: 20px; font-weight: 800; color: #0f172a; }

        table { width: 100%; border-collapse: collapse; margin-bottom: 40px; }
        th { text-align: left; background: #f8fafc; padding: 12px 16px; font-size: 11px; font-weight: 800; text-transform: uppercase; border-bottom: 2px solid #e2e8f0; }
...
<body>
    ...
    @if($type === 'consolidated')
        <div class="stats-grid">
            ...
            <div class="stat-box">
                ...
                <div class="stat-value">{{ $data->count() }} Cabang</div>
            </div>
        </div>
    ...
    @else
        <div class="stats-grid">
            <div class="stat-box">
                <div class="stat-label">Nama Cabang</div>
            ...
            <div class="stat-box">
                ...
                <div class="stat-value">{{ count($data['orders']) }} Hari/Data</div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-transform:uppercase; font-size:11px; font-weight:700;">{{ $order->status }}</td>
            ...
            <tfoot>
                <tr class="totals-row">
                    <td colspan="3">TOTAL REVENUE CABANG</td>
